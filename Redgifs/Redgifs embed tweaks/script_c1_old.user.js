...
async function getVideo() {
    videoRoot = await asyncQuerySelector("video");
}
...
async function initVideo() {
    ...
    if (getState("openLink")) {
        videoRoot.parentElemente.removeAttribute("href");
    }
...
async function downloadAsBlob(vUrl) {
    if (isInIframe()) {
        return unsafeWindow.parent.postMessage({ redUrl: vUrl }, "*");
    }
...
function isInIframe() {
    return unsafeWindow !== unsafeWindow.parent;
}
...
const consoles = {
    log: {
        original: unsafeWindow.console.log,
    },
    debug: {
        original: unsafeWindow.console.debug,
    },
    info: {
        original: unsafeWindow.console.info,
    },
    warn: {
        original: unsafeWindow.console.warn,
    },
    error: {
        original: unsafeWindow.console.error,
    },
    table: {
        original: unsafeWindow.console.table,
    },
    assert: {
        original: unsafeWindow.console.assert,
    },
    clear: {
        original: unsafeWindow.console.clear,
    },
    // group: {
    //     original: unsafeWindow.console.group,
    // },
    // groupCollapsed: {
    //     original: unsafeWindow.console.groupCollapsed,
    // },
    // groupEnd: {
    //     original: unsafeWindow.console.groupEnd,
    // },
    // time: {
    //     original: unsafeWindow.console.time,
    // },
    // timeEnd: {
    //     original: unsafeWindow.console.timeEnd,
    // },
    // timeLog: {
    //     original: unsafeWindow.console.timeLog,
    // },
    // trace: {
    //     original: unsafeWindow.console.trace,
    // },
    // dir: {
    //     original: unsafeWindow.console.dir,
    // },
    // dirxml: {
    //     original: unsafeWindow.console.dirxml,
    // },
    // profile: {
    //     original: unsafeWindow.console.profile,
    // },
    // profileEnd: {
    //     original: unsafeWindow.console.profileEnd,
    // },
    // count: {
    //     original: unsafeWindow.console.count,
    // },
    // countReset: {
    //     original: unsafeWindow.console.countReset,
    // },
    // timeStamp: {
    //     original: unsafeWindow.console.timeStamp,
    // },
    // context: {
    //     original: unsafeWindow.console.context,
    // },
    // memory: {
    //     original: unsafeWindow.console.memory,
    // },
};
// let log = "";

// for (const csl in consoles) {
//     consoles.log.original("EE");

//     const original = consoles[csl].original;

//     unsafeWindow.console[csl] = function (...args) {
